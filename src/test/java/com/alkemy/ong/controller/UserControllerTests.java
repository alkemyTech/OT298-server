...
public class UserControllerTests {
    ...
    void test_no_admin(TestInfo testInfo) throws Exception {
        ...
        when(service.getAllAuxUsers()).thenReturn(generateUserList());
    ...
    void test_get_all_users(TestInfo testInfo) throws Exception {
        ...
        List<AuxUserGetDto> expected = generateUserList();
    ...
    void test_update(TestInfo testInfo) throws Exception {
        logger.info(testInfo.getDisplayName(), "should return 200");
        AuxUserGetDto expected = generateUserList().get(0);
        UserPostDto request = generateUserPostDto().get(0);
    ...
    void valid_delete_test(TestInfo testInfo) throws Exception {
        logger.info(testInfo.getDisplayName(), "should return 200");
        AuxUserGetDto response = generateUserList().get(0);
    ...
    public List<UserPostDto> generateUserPostDto() {
    ...
    public List<AuxUserGetDto> generateUserList() {
